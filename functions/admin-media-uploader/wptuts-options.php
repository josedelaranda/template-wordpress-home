...
// Add "Custom image uploader" link to the "Appearance" menu
function wptuts_menu_options() {
	//add_theme_page( $page_title, $menu_title, $capability, $menu_slug, $function);
     add_theme_page('Custom image uploader', 'Custom image uploader', 'edit_theme_options', 'wptuts-settings', 'wptuts_admin_options_page');
}
...
function wptuts_admin_options_page() {
	?>
		...
		<div class="wrap">
			...
			<h2><?php _e( 'Custom image uploader', 'wptuts' ); ?></h2>
...
function wptuts_options_enqueue_scripts() {
	wp_register_script( 'wptuts-upload', get_template_directory_uri() .'/functions/admin-media-uploader/js/wptuts-upload.js', array('jquery','media-upload','thickbox') );	
...
function wptuts_settings_header_text() {
	?>
		<p><?php _e( 'Agregar una imagen destacada a mi template', 'wptuts' ); ?></p>
	<?php
}
